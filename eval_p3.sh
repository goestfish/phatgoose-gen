...
WriteOutputText.save_dir="exp_out/p3_gen/output_text"
RoutingDistribution.save_dir="exp_out/p3_gen/routing_distribution"
...
'
echo "Done. Check exp_out/p3_gen/ and logs/*.out, *.err"