...
class BigBenchDataset(Dataset):
    def __init__(self, interface="mc", **kwargs):
        super().__init__(**kwargs)
        self.interface_info.interface = interface
    ...
    def __getitem__(self, idx):
        ...
        interface_kind = getattr(self.interface_info, "interface", None)
        is_gen = interface_kind in ("gen", "generation")
